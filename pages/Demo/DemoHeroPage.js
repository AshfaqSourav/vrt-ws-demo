...
const selector = 'section.min-h-screen.relative';
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/demoHero${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/demoHero${this.viewport}.png`;
