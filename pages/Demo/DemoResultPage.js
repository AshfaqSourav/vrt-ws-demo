...
const selector = "section[class*='bg-[#171320']";





export class DemoResultPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/demoResult${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/demoResult${this.viewport}.png`;
