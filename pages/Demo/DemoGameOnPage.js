...
const selector = 'section#choose-store-stepper.wrapper';




export class DemoGameOnPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/demoGameOn${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/demoGameOn${this.viewport}.png`;
