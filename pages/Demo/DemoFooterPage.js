// /path/to/Demo/DemoFooterPage.js
...
const selector = 'footer[class^="bg-"]';


export class DemoFooterPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/demoFooter${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/demoFooter${this.viewport}.png`;
