...
const selector = 'div.sc-kcLKEh';



export class CapAuthSalesCardPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthSalesCard${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthSalesCard${this.viewport}.png`;
