...
const selector = '.sc-eNLTQs.bAsGtv';


export class CapAuthFormPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthForm${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthForm${this.viewport}.png`;
