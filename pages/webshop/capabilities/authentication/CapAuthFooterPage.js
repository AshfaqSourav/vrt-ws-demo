...
export class CapAuthFooterPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthFooter${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthFooter${this.viewport}.png`;
