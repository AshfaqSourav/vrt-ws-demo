...
const selector = '.sc-kYLqRS.AAgtZ';//div[@class='sc-hQQqCA lnHQMG']//DocCard


export class CapAuthSuccessStoryPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthSuccessStory${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthSuccessStory${this.viewport}.png`;
