...
const selector = '.sc-hQQqCA.lnHQMG';//div[@class='sc-hQQqCA lnHQMG']//DocCard


export class CapAuthDocCardPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthDocCard${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthDocCard${this.viewport}.png`;
