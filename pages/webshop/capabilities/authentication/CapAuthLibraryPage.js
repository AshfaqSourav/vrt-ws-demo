...
const selector = '.sc-kNOymR.kfRzAJ.sc-hwkwBN.sc-ixyMIc.ghmPUW.ioUnvb';


export class CapAuthLibraryPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/capAuthLibrary${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/capAuthLibrary${this.viewport}.png`;
