...
export class MainVideoCardPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainVideoCard${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainVideoCard${this.viewport}.png`;
