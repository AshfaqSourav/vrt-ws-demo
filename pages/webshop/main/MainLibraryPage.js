...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainLibrary${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainLibrary${this.viewport}.png`;
