...
export class MainLogoGardenPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainLogoGarden${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainLogoGarden${this.viewport}.png`;
