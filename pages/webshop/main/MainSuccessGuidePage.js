...
export class MainSuccessGuidePage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainSuccessGuide${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainSuccessGuide${this.viewport}.png`;
