...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainPlatform${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainPlatform${this.viewport}.png`;
