...
export class MainSuccessStoryPage {
...
async takeScreenshot() {
  ...
  const maskedFullPagePath = `${diffDir}/mainSuccessStory${this.viewport}-masked-full.png`;
  const croppedElementPath = `${diffDir}/mainSuccessStory${this.viewport}.png`;
